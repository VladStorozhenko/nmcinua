...
function nmc_enqueue_styles() {
    ...
    wp_enqueue_style('nmc-header-footer-css', get_template_directory_uri() . '/inc/css/header_footer.min.css', array(), '1.0.0', 'all');

    // Main css -- enqueue in index.php

    wp_register_style('nmc-main-css', get_template_directory_uri() . '/inc/css/main.min.css', array(), '1.0.0', 'all');

    // About us css -- enqueue in page_templates/about_us.php

    wp_register_style('nmc-about-us-css', get_template_directory_uri() . '/inc/css/about_us.min.css', array(), '1.0.0', 'all');

    // Services css -- enqueue in page_templates/services.php

    wp_register_style('nmc-services-css', get_template_directory_uri() . '/inc/css/services.min.css', array(), '1.0.0', 'all');

    // Specialists css -- enqueue in page_templates/services.php

    wp_register_style('nmc-specialists-css', get_template_directory_uri() . '/inc/css/specialists.min.css', array(), '1.0.0', 'all');

    // Contacts css -- enqueue in page_templates/contacts.php

    wp_register_style('nmc-contacts-css', get_template_directory_uri() . '/inc/css/contacts.min.css', array(), '1.0.0', 'all');

    // Schedule css -- enqueue in page_templates/schedule.php

    wp_register_style('nmc-schedule-css', get_template_directory_uri() . '/inc/css/schedule.min.css', array(), '1.0.0', 'all');
...
function nmc_enqueue_scripts () {
    wp_enqueue_script('jquery-ui', "https://code.jquery.com/ui/1.12.1/jquery-ui.js", array('jquery'), '1.0.0', true);
    
    wp_enqueue_script('datepicker', "https://cdnjs.cloudflare.com/ajax/libs/datepicker/1.0.10/datepicker.min.js", array('jquery', 'jquery-ui'), '1.0.0', true);
    
    wp_enqueue_script('datepicker-ru', "https://cdnjs.cloudflare.com/ajax/libs/datepicker/1.0.10/i18n/datepicker.ru-RU.min.js", array('jquery', 'jquery-ui', 'datepicker'), '1.0.0', true);
    ...
    wp_register_script('nmc-specialist', get_template_directory_uri() . '/inc/js/specialist.js', array('jquery', 'jquery-ui-datepicker', 'datepicker-ru'), '1.0.0', true);

    // schedule scripts -- enqueue in page_templates/schedule.js

    wp_register_script('nmc-schedule-js', get_template_directory_uri() . '/inc/js/schedule.js', array('jquery', 'jquery-ui-datepicker', 'datepicker-ru'), '1.0.0', true);

    // slim select -- enqueue in page_templates/schedule.js

    wp_register_script('nmc-slim-js', 'https://cdnjs.cloudflare.com/ajax/libs/slim-select/1.26.0/slimselect.min.js', array('jquery', 'jquery-ui-datepicker'), null, true);
