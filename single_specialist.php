...
<div class="container breadcrumbs-on-page">
    ...
    <p class='breadcrumbs'><a href="<?php echo $home_url ?>">ГЛАВНАЯ</a>/<a href="<?php echo $services_url ?>">СПЕЦИАЛИСТЫ</a>/<a href="<?php echo $post->guid; ?>" class='last'><?php echo $post->post_title; ?></a></p>
        ...
        <div class="col-12 col-lg-7 d-flex flex-column justify-content-center info-block">
            ...
            <div class='top-info-action-wrapper'>
                ...
                if (!$disable_appointments) {
                    ?>
                    <button class="button button-blue" data-toggle="modal" data-target="#speciliastModal" id='specialist-button' data-daystoenable="<?php echo $json; ?>" data-specialist='<?php the_title(); ?>'>Записаться на приём</button>
